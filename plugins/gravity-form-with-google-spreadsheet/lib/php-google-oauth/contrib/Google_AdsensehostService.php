 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adsensehostService = new GFGS_Google_AdSenseHostService(...);
  ...
  class GFGS_Google_AccountsAdclientsServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function get($accountId, $adClientId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_AdClient($data);
      } else {
        return $data;
      }
    }
  ...
  class GFGS_Google_AccountsAdunitsServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function getAdCode($accountId, $adClientId, $adUnitId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_AdCode($data);
      } else {
        return $data;
      }
    }
     ...
     * @param GFGS_Google_AdUnit $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_AdUnit
     */
    public function insert($accountId, $adClientId, GFGS_Google_AdUnit $postBody, $optParams = array()) {
     ...
     * @return GFGS_Google_AdUnit
     */
    public function patch($accountId, $adClientId, $adUnitId, GFGS_Google_AdUnit $postBody, $optParams = array()) {
     ...
     * @return GFGS_Google_AdUnit
     */
    public function update($accountId, $adClientId, GFGS_Google_AdUnit $postBody, $optParams = array()) {
      $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class GFGS_Google_AssociationSessionsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_AssociationSession
     */
    public function start($productCode, $websiteUrl, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_AssociationSession($data);
      } else {
        return $data;
      }
    }
  ...
  class GFGS_Google_CustomchannelsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @param GFGS_Google_CustomChannel $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_CustomChannel
     */
    public function insert($adClientId, GFGS_Google_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return GFGS_Google_CustomChannel
     */
    public function patch($adClientId, $customChannelId, GFGS_Google_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return GFGS_Google_CustomChannel
     */
    public function update($adClientId, GFGS_Google_CustomChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
  ...
  class GFGS_Google_UrlchannelsServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function delete($adClientId, $urlChannelId, $optParams = array()) {
      ...
      $data = $this->__call('delete', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_UrlChannel($data);
      } else {
        return $data;
      }
    }
     ...
     * @param GFGS_Google_UrlChannel $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_UrlChannel
     */
    public function insert($adClientId, GFGS_Google_UrlChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
 ...
 * @author Google, Inc.
 */
class GFGS_Google_AdSenseHostService extends GFGS_Google_Service {
  public $accounts;
...
class GFGS_Google_AdCode extends GFGS_Google_Model {
  public $adCode;
  public $kind;
...
class GFGS_Google_AssociationSession extends GFGS_Google_Model {
  public $accountId;
  public $id;
  public $kind;
  public $productCodes;
