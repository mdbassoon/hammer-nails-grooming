 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $freebaseService = new GFGS_Google_FreebaseService(...);
   *   $text = $freebaseService->text;
   *  </code>
   */
  class GFGS_Google_TextServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_ContentserviceGet
     */
    public function get($id, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_ContentserviceGet($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class GFGS_Google_FreebaseService extends GFGS_Google_Service {
  public $text;
  /**
