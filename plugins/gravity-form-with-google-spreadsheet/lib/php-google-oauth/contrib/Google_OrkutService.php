 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $orkutService = new GFGS_Google_OrkutService(...);
   *   $communityMembers = $orkutService->communityMembers;
   *  </code>
   */
  class GFGS_Google_CommunityMembersServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_CommunityMembers
     */
    public function insert($communityId, $userId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityMembers($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return GFGS_Google_CommunityMembersList
     */
    public function listCommunityMembers($communityId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityMembersList($data);
      } else {
        return $data;
      }
    }
  ...
  class GFGS_Google_ActivitiesServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return GFGS_Google_ActivityList
     */
    public function listActivities($userId, $collection, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_ActivityList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_CommunityPollCommentsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @param GFGS_Google_CommunityPollComment $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_CommunityPollComment
     */
    public function insert($communityId, $pollId, GFGS_Google_CommunityPollComment $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'pollId' => $pollId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityPollComment($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return GFGS_Google_CommunityPollCommentList
     */
    public function listCommunityPollComments($communityId, $pollId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityPollCommentList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_CommunityPollsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return GFGS_Google_CommunityPollList
     */
    public function listCommunityPolls($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityPollList($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return GFGS_Google_CommunityPoll
     */
    public function get($communityId, $pollId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityPoll($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_CommunityMessagesServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @param GFGS_Google_CommunityMessage $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_CommunityMessage
     */
    public function insert($communityId, $topicId, GFGS_Google_CommunityMessage $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'topicId' => $topicId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityMessage($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return GFGS_Google_CommunityMessageList
     */
    public function listCommunityMessages($communityId, $topicId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityMessageList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_CommunityTopicsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @param GFGS_Google_CommunityTopic $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param bool isShout Whether this topic is a shout.
     * @return GFGS_Google_CommunityTopic
     */
    public function insert($communityId, GFGS_Google_CommunityTopic $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityTopic($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return GFGS_Google_CommunityTopicList
     */
    public function listCommunityTopics($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityTopicList($data);
      } else {
        return $data;
      }
    }
  ...
  class GFGS_Google_CommentsServiceResource extends GFGS_Google_ServiceResource {
     ...
     */
    public function insert($activityId, GFGS_Google_Comment $postBody, $optParams = array()) {
   ...
   *  </code>
   */
  class GFGS_Google_AclServiceResource extends GFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class GFGS_Google_CommunityRelatedServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return GFGS_Google_CommunityList
     */
    public function listCommunityRelated($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_ScrapsServiceResource extends GFGS_Google_ServiceResource {
     ...
     */
    public function insert(GFGS_Google_Activity $postBody, $optParams = array()) {
   ...
   *  </code>
   */
  class GFGS_Google_CommunityPollVotesServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @param GFGS_Google_CommunityPollVote $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_CommunityPollVote
     */
    public function insert($communityId, $pollId, GFGS_Google_CommunityPollVote $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'pollId' => $pollId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CommunityPollVote($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_CommunitiesServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function get($communityId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Community($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_CommunityFollowServiceResource extends GFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class GFGS_Google_ActivityVisibilityServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @param string $activityId ID of the activity.
     * @param GFGS_Google_Visibility $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Visibility
     */
    public function patch($activityId, GFGS_Google_Visibility $postBody, $optParams = array()) {
      $params = array('activityId' => $activityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Visibility($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GFGS_Google_Visibility
     */
    public function update($activityId, GFGS_Google_Visibility $postBody, $optParams = array()) {
      $params = array('activityId' => $activityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class GFGS_Google_BadgesServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listBadges($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_BadgeList($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($userId, $badgeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Badge($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_CountersServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listCounters($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Counters($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class GFGS_Google_OrkutService extends GFGS_Google_Service {
...
class GFGS_Google_AclItems extends GFGS_Google_Model {
  public $type;
  public $id;
...
class GFGS_Google_Activity extends GFGS_Google_Model {
  public $kind;
  protected $__linksType = 'GFGS_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  public $title;
  protected $__objectType = 'GFGS_Google_ActivityObject';
  protected $__objectDataType = '';
  public $object;
  public $updated;
  protected $__actorType = 'GFGS_Google_OrkutAuthorResource';
  protected $__actorDataType = '';
  public $actor;
  protected $__accessType = 'GFGS_Google_Acl';
  ...
  public function setLinks(/* array(GFGS_Google_OrkutLinkResource) */ $links) {
    $this->assertIsArray($links, 'GFGS_Google_OrkutLinkResource', __METHOD__);
    $this->links = $links;
  }
  ...
  public function setObject(GFGS_Google_ActivityObject $object) {
    $this->object = $object;
  }
  ...
  public function setActor(GFGS_Google_OrkutAuthorResource $actor) {
    $this->actor = $actor;
  }
  public function getActor() {
    return $this->actor;
  }
  public function setAccess(GFGS_Google_Acl $access) {
    $this->access = $access;
  }
...
class GFGS_Google_ActivityList extends GFGS_Google_Model {
...
class GFGS_Google_ActivityObject extends GFGS_Google_Model {
  public $content;
  protected $__itemsType = 'GFGS_Google_OrkutActivityobjectsResource';
  protected $__itemsDataType = 'array';
  public $items;
  protected $__repliesType = 'GFGS_Google_ActivityObjectReplies';
  ...
  public function setItems(/* array(GFGS_Google_OrkutActivityobjectsResource) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_OrkutActivityobjectsResource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  }
  public function setReplies(GFGS_Google_ActivityObjectReplies $replies) {
...
class GFGS_Google_ActivityObjectReplies extends GFGS_Google_Model {
  public $totalItems;
...
class GFGS_Google_Badge extends GFGS_Google_Model {
...
class GFGS_Google_BadgeList extends GFGS_Google_Model {
  protected $__itemsType = 'GFGS_Google_Badge';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(GFGS_Google_Badge) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Badge', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Comment extends GFGS_Google_Model {
  protected $__inReplyToType = 'GFGS_Google_CommentInReplyTo';
  ...
  public $published;
  public $id;
  public function setInReplyTo(GFGS_Google_CommentInReplyTo $inReplyTo) {
...
class GFGS_Google_CommentInReplyTo extends GFGS_Google_Model {
  public $type;
  public $href;
  public $ref;
  public $rel;
...
class GFGS_Google_Community extends GFGS_Google_Model {
  public $category;
  public $kind;
  public $member_count;
  public $description;
  ...
  protected $__ownerType = 'GFGS_Google_OrkutAuthorResource';
  protected $__ownerDataType = '';
  public $owner;
  protected $__moderatorsType = 'GFGS_Google_OrkutAuthorResource';
  protected $__moderatorsDataType = 'array';
  public $moderators;
  public $location;
  protected $__co_ownersType = 'GFGS_Google_OrkutAuthorResource';
  ...
  public function setOwner(GFGS_Google_OrkutAuthorResource $owner) {
    $this->owner = $owner;
  }
  public function getOwner() {
    return $this->owner;
  }
  public function setModerators(/* array(GFGS_Google_OrkutAuthorResource) */ $moderators) {
    $this->assertIsArray($moderators, 'GFGS_Google_OrkutAuthorResource', __METHOD__);
  ...
  public function setCo_owners(/* array(GFGS_Google_OrkutAuthorResource) */ $co_owners) {
    $this->assertIsArray($co_owners, 'GFGS_Google_OrkutAuthorResource', __METHOD__);
...
class GFGS_Google_CommunityList extends GFGS_Google_Model {
  protected $__itemsType = 'GFGS_Google_Community';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(GFGS_Google_Community) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Community', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_CommunityMembers extends GFGS_Google_Model {
  protected $__communityMembershipStatusType = 'GFGS_Google_CommunityMembershipStatus';
  protected $__communityMembershipStatusDataType = '';
  public $communityMembershipStatus;
  protected $__personType = 'GFGS_Google_OrkutActivitypersonResource';
  protected $__personDataType = '';
  public $person;
  public $kind;
  public function setCommunityMembershipStatus(GFGS_Google_CommunityMembershipStatus $communityMembershipStatus) {
  ...
  public function setPerson(GFGS_Google_OrkutActivitypersonResource $person) {
    $this->person = $person;
  }
...
class GFGS_Google_CommunityMembersList extends GFGS_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'GFGS_Google_CommunityMembers';
  protected $__itemsDataType = 'array';
  public $items;
  ...
  public function setItems(/* array(GFGS_Google_CommunityMembers) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_CommunityMembers', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_CommunityMembershipStatus extends GFGS_Google_Model {
  public $status;
  public $isFollowing;
...
class GFGS_Google_CommunityMessage extends GFGS_Google_Model {
  public $body;
  public $kind;
  protected $__linksType = 'GFGS_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  protected $__authorType = 'GFGS_Google_OrkutAuthorResource';
  ...
  public function setAuthor(GFGS_Google_OrkutAuthorResource $author) {
    $this->author = $author;
  }
...
class GFGS_Google_CommunityMessageList extends GFGS_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'GFGS_Google_CommunityMessage';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(GFGS_Google_CommunityMessage) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_CommunityMessage', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_CommunityPoll extends GFGS_Google_Model {
  protected $__linksType = 'GFGS_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  public $isMultipleAnswers;
  protected $__imageType = 'GFGS_Google_CommunityPollImage';
  ...
  public $kind;
  public $creationTime;
  protected $__optionsType = 'GFGS_Google_OrkutCommunitypolloptionResource';
  ...
  public function setImage(GFGS_Google_CommunityPollImage $image) {
    $this->image = $image;
  }
  ...
  public function setOptions(/* array(GFGS_Google_OrkutCommunitypolloptionResource) */ $options) {
    $this->assertIsArray($options, 'GFGS_Google_OrkutCommunitypolloptionResource', __METHOD__);
...
class GFGS_Google_CommunityPollComment extends GFGS_Google_Model {
  public $body;
  public $kind;
  public $addedDate;
  public $id;
...
class GFGS_Google_CommunityPollCommentList extends GFGS_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'GFGS_Google_CommunityPollComment';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(GFGS_Google_CommunityPollComment) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_CommunityPollComment', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_CommunityPollImage extends GFGS_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class GFGS_Google_CommunityPollList extends GFGS_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'GFGS_Google_CommunityPoll';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(GFGS_Google_CommunityPoll) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_CommunityPoll', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_CommunityPollVote extends GFGS_Google_Model {
  public $kind;
  public $optionIds;
...
class GFGS_Google_CommunityTopic extends GFGS_Google_Model {
  public $body;
  public $lastUpdate;
  public $kind;
  protected $__linksType = 'GFGS_Google_OrkutLinkResource';
  ...
  public $author;
  public $title;
  protected $__messagesType = 'GFGS_Google_CommunityMessage';
  ...
  public function setMessages(/* array(GFGS_Google_CommunityMessage) */ $messages) {
    $this->assertIsArray($messages, 'GFGS_Google_CommunityMessage', __METHOD__);
...
class GFGS_Google_CommunityTopicList extends GFGS_Google_Model {
  public $nextPageToken;
  public $kind;
  protected $__itemsType = 'GFGS_Google_CommunityTopic';
  protected $__itemsDataType = 'array';
  public $items;
  public $prevPageToken;
  public $lastPageToken;
  ...
  public function setItems(/* array(GFGS_Google_CommunityTopic) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_CommunityTopic', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Counters extends GFGS_Google_Model {
  protected $__itemsType = 'GFGS_Google_OrkutCounterResource';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(GFGS_Google_OrkutCounterResource) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_OrkutCounterResource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_OrkutActivityobjectsResource extends GFGS_Google_Model {
  public $displayName;
  protected $__linksType = 'GFGS_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  protected $__communityType = 'GFGS_Google_Community';
  ...
  public function setCommunity(GFGS_Google_Community $community) {
...
class GFGS_Google_OrkutActivitypersonResource extends GFGS_Google_Model {
  protected $__nameType = 'GFGS_Google_OrkutActivitypersonResourceName';
  protected $__nameDataType = '';
  public $name;
  public $url;
  public $gender;
  protected $__imageType = 'GFGS_Google_OrkutActivitypersonResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $birthday;
  public $id;
  public function setName(GFGS_Google_OrkutActivitypersonResourceName $name) {
    $this->name = $name;
  }
  public function getName() {
    return $this->name;
  ...
  public function setImage(GFGS_Google_OrkutActivitypersonResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class GFGS_Google_OrkutActivitypersonResourceImage extends GFGS_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class GFGS_Google_OrkutActivitypersonResourceName extends GFGS_Google_Model {
  public $givenName;
  public $familyName;
...
class GFGS_Google_OrkutAuthorResource extends GFGS_Google_Model {
  public $url;
  protected $__imageType = 'GFGS_Google_OrkutAuthorResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(GFGS_Google_OrkutAuthorResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class GFGS_Google_OrkutAuthorResourceImage extends GFGS_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class GFGS_Google_OrkutCommunitypolloptionResource extends GFGS_Google_Model {
  protected $__imageType = 'GFGS_Google_OrkutCommunitypolloptionResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $optionId;
  public $description;
  public $numberOfVotes;
  public function setImage(GFGS_Google_OrkutCommunitypolloptionResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class GFGS_Google_OrkutCommunitypolloptionResourceImage extends GFGS_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class GFGS_Google_OrkutCounterResource extends GFGS_Google_Model {
  public $total;
  protected $__linkType = 'GFGS_Google_OrkutLinkResource';
  ...
  public function setLink(GFGS_Google_OrkutLinkResource $link) {
    $this->link = $link;
  }
...
class GFGS_Google_OrkutLinkResource extends GFGS_Google_Model {
  public $href;
  public $type;
  public $rel;
  public $title;
...
class GFGS_Google_Visibility extends GFGS_Google_Model {
  public $kind;
  public $visibility;
  protected $__linksType = 'GFGS_Google_OrkutLinkResource';
  protected $__linksDataType = 'array';
