 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $tasksService = new GFGS_Google_TasksService(...);
   *   $tasks = $tasksService->tasks;
   *  </code>
   */
  class GFGS_Google_TasksServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @param GFGS_Google_Task $postBody
     ...
     * @return GFGS_Google_Task
     */
    public function insert($tasklist, GFGS_Google_Task $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Task($data);
      } else {
        return $data;
      }
    }
    ...
    public function listTasks($tasklist, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_Tasks($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GFGS_Google_Task
     */
    public function update($tasklist, $task, GFGS_Google_Task $postBody, $optParams = array()) {
     ...
     * @return GFGS_Google_Task
     */
    public function patch($tasklist, $task, GFGS_Google_Task $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'task' => $task, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class GFGS_Google_TasklistsServiceResource extends GFGS_Google_ServiceResource {


    /**
     * Creates a new task list and adds it to the authenticated user's task lists. (tasklists.insert)
     *
     * @param GFGS_Google_TaskList $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_TaskList
     */
    public function insert(GFGS_Google_TaskList $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_TaskList($data);
      } else {
        return $data;
      }
    }
    ...
    public function listTasklists($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_TaskLists($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GFGS_Google_TaskList
     */
    public function update($tasklist, GFGS_Google_TaskList $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
     ...
     * @return GFGS_Google_TaskList
     */
    public function patch($tasklist, GFGS_Google_TaskList $postBody, $optParams = array()) {
      $params = array('tasklist' => $tasklist, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for GFGS_Google_Tasks (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class GFGS_Google_TasksService extends GFGS_Google_Service {
  public $tasks;
  public $tasklists;
  /**
...
class GFGS_Google_Task extends GFGS_Google_Model {
  ...
  public function setLinks(/* array(GFGS_Google_TaskLinks) */ $links) {
    $this->assertIsArray($links, 'GFGS_Google_TaskLinks', __METHOD__);
    $this->links = $links;
  }
...
class GFGS_Google_TaskLinks extends GFGS_Google_Model {
  public $type;
  public $link;
  public $description;
...
class GFGS_Google_TaskList extends GFGS_Google_Model {
  public $kind;
  public $title;
  public $updated;
  public $etag;
...
class GFGS_Google_TaskLists extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_TaskList';
  ...
  public function setItems(/* array(GFGS_Google_TaskList) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_TaskList', __METHOD__);
    $this->items = $items;
  }
...
class GFGS_Google_Tasks extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Task';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $etag;
  ...
  public function setItems(/* array(GFGS_Google_Task) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Task', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
