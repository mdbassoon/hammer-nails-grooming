 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $bloggerService = new GFGS_Google_BloggerService(...);
   *   $blogs = $bloggerService->blogs;
   *  </code>
   */
  class GFGS_Google_BlogsServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listByUser($userId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_BlogList($data);
      } else {
        return $data;
      }
    }
    ...
    public function getByUrl($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_Blog($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_PostsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @param GFGS_Google_Post $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Post
     */
    public function insert($blogId, GFGS_Google_Post $postBody, $optParams = array()) {
      $params = array('blogId' => $blogId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Post($data);
      } else {
        return $data;
      }
    }
    ...
    public function search($blogId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_PostList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GFGS_Google_Post
     */
    public function update($blogId, $postId, GFGS_Google_Post $postBody, $optParams = array()) {
     ...
     * @return GFGS_Google_Post
     */
    public function patch($blogId, $postId, GFGS_Google_Post $postBody, $optParams = array()) {
      $params = array('blogId' => $blogId, 'postId' => $postId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class GFGS_Google_PagesServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listPages($blogId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_PageList($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($blogId, $pageId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Page($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_UsersServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function get($userId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_User($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class GFGS_Google_BloggerService extends GFGS_Google_Service {
  public $blogs;
  public $posts;
  public $pages;
  public $comments;
  ...
  public function __construct(GFGSC_Google_Client_Connector $client) {
    ...
    $this->users = new GFGS_Google_UsersServiceResource($this, $this->serviceName, 'users', json_decode('{"methods": {"get": {"scopes": ["https://www.googleapis.com/auth/blogger", "https://www.googleapis.com/auth/blogger.readonly"], "parameters": {"userId": {"required": true, "type": "string", "location": "path"}}, "id": "blogger.users.get", "httpMethod": "GET", "path": "users/{userId}", "response": {"$ref": "User"}}}}', true));

  }
}

class GFGS_Google_Blog extends GFGS_Google_Model {
  public $kind;
  public $description;
  protected $__localeType = 'GFGS_Google_BlogLocale';
  protected $__localeDataType = '';
  public $locale;
  protected $__postsType = 'GFGS_Google_BlogPosts';
  protected $__postsDataType = '';
  public $posts;
  public $customMetaData;
  public $updated;
  protected $__pagesType = 'GFGS_Google_BlogPages';
  ...
  public function setLocale(GFGS_Google_BlogLocale $locale) {
    $this->locale = $locale;
  }
  public function getLocale() {
    return $this->locale;
  }
  public function setPosts(GFGS_Google_BlogPosts $posts) {
    $this->posts = $posts;
  }
  ...
  public function setPages(GFGS_Google_BlogPages $pages) {
    $this->pages = $pages;
  }
...
class GFGS_Google_BlogList extends GFGS_Google_Model {
  protected $__itemsType = 'GFGS_Google_Blog';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(GFGS_Google_Blog) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Blog', __METHOD__);
    $this->items = $items;
  }
...
class GFGS_Google_BlogLocale extends GFGS_Google_Model {
  public $country;
  public $variant;
  public $language;
...
class GFGS_Google_BlogPages extends GFGS_Google_Model {
  public $totalItems;
  public $selfLink;
...
class GFGS_Google_BlogPosts extends GFGS_Google_Model {
  public $totalItems;
  protected $__itemsType = 'GFGS_Google_Post';
  protected $__itemsDataType = 'array';
  public $items;
  public $selfLink;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(GFGS_Google_Post) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Post', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Comment extends GFGS_Google_Model {
  ...
  public $inReplyTo;
  protected $__authorType = 'GFGS_Google_CommentAuthor';
  protected $__authorDataType = '';
  public $author;
  public $updated;
  protected $__blogType = 'GFGS_Google_CommentBlog';
  protected $__blogDataType = '';
  public $blog;
  public $published;
  protected $__postType = 'GFGS_Google_CommentPost';
  ...
  public function setAuthor(GFGS_Google_CommentAuthor $author) {
    $this->author = $author;
  }
  ...
  public function setBlog(GFGS_Google_CommentBlog $blog) {
    $this->blog = $blog;
  }
  ...
  public function setPost(GFGS_Google_CommentPost $post) {
    $this->post = $post;
  }
...
class GFGS_Google_CommentAuthor extends GFGS_Google_Model {
  public $url;
  protected $__imageType = 'GFGS_Google_CommentAuthorImage';
  ...
  public function setImage(GFGS_Google_CommentAuthorImage $image) {
    $this->image = $image;
  }
...
class GFGS_Google_CommentAuthorImage extends GFGS_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class GFGS_Google_CommentBlog extends GFGS_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class GFGS_Google_CommentPost extends GFGS_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class GFGS_Google_Page extends GFGS_Google_Model {
  public $content;
  public $kind;
  protected $__authorType = 'GFGS_Google_PageAuthor';
  protected $__authorDataType = '';
  public $author;
  public $url;
  public $title;
  public $updated;
  protected $__blogType = 'GFGS_Google_PageBlog';
  protected $__blogDataType = '';
  public $blog;
  public $published;
  public $id;
  ...
  public function setAuthor(GFGS_Google_PageAuthor $author) {
    $this->author = $author;
  }
  public function getAuthor() {
    return $this->author;
  ...
  public function setBlog(GFGS_Google_PageBlog $blog) {
    $this->blog = $blog;
  }
  public function getBlog() {
    return $this->blog;
...
class GFGS_Google_PageAuthor extends GFGS_Google_Model {
  public $url;
  protected $__imageType = 'GFGS_Google_PageAuthorImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(GFGS_Google_PageAuthorImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class GFGS_Google_PageAuthorImage extends GFGS_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class GFGS_Google_PageBlog extends GFGS_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class GFGS_Google_PageList extends GFGS_Google_Model {
  protected $__itemsType = 'GFGS_Google_Page';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(GFGS_Google_Page) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Page', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Post extends GFGS_Google_Model {
  public $content;
  public $kind;
  protected $__authorType = 'GFGS_Google_PostAuthor';
  protected $__authorDataType = '';
  public $author;
  protected $__repliesType = 'GFGS_Google_PostReplies';
  protected $__repliesDataType = '';
  public $replies;
  public $labels;
  public $customMetaData;
  public $updated;
  protected $__blogType = 'GFGS_Google_PostBlog';
  protected $__blogDataType = '';
  public $blog;
  public $url;
  protected $__locationType = 'GFGS_Google_PostLocation';
  ...
  public function setAuthor(GFGS_Google_PostAuthor $author) {
    $this->author = $author;
  }
  public function getAuthor() {
    return $this->author;
  }
  public function setReplies(GFGS_Google_PostReplies $replies) {
  ...
  public function setBlog(GFGS_Google_PostBlog $blog) {
    $this->blog = $blog;
  }
  public function getBlog() {
    return $this->blog;
  ...
  public function setLocation(GFGS_Google_PostLocation $location) {
...
class GFGS_Google_PostAuthor extends GFGS_Google_Model {
  public $url;
  protected $__imageType = 'GFGS_Google_PostAuthorImage';
  protected $__imageDataType = '';
  public $image;
  public $displayName;
  public $id;
  ...
  public function setImage(GFGS_Google_PostAuthorImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class GFGS_Google_PostAuthorImage extends GFGS_Google_Model {
  public $url;
  public function setUrl($url) {
    $this->url = $url;
  }
...
class GFGS_Google_PostBlog extends GFGS_Google_Model {
  public $id;
  public function setId($id) {
    $this->id = $id;
  }
...
class GFGS_Google_PostList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Post';
  protected $__itemsDataType = 'array';
  public $items;
...
class GFGS_Google_PostLocation extends GFGS_Google_Model {
  public $lat;
  public $lng;
  public $span;
  public $name;
...
class GFGS_Google_PostReplies extends GFGS_Google_Model {
  public $totalItems;
  protected $__itemsType = 'GFGS_Google_Comment';
  protected $__itemsDataType = 'array';
  public $items;
...
class GFGS_Google_User extends GFGS_Google_Model {
  ...
  public $displayName;
  public $created;
  protected $__localeType = 'GFGS_Google_UserLocale';
  protected $__localeDataType = '';
  public $locale;
  protected $__blogsType = 'GFGS_Google_UserBlogs';
  ...
  public function setLocale(GFGS_Google_UserLocale $locale) {
    $this->locale = $locale;
  }
  public function getLocale() {
    return $this->locale;
  }
  public function setBlogs(GFGS_Google_UserBlogs $blogs) {
    $this->blogs = $blogs;
  }
...
class GFGS_Google_UserBlogs extends GFGS_Google_Model {
  public $selfLink;
  public function setSelfLink($selfLink) {
    $this->selfLink = $selfLink;
  }
...
class GFGS_Google_UserLocale extends GFGS_Google_Model {
  public $country;
  public $variant;
  public $language;
  public function setCountry($country) {
