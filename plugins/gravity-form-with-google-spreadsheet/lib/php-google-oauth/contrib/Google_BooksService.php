 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $booksService = new GFGS_Google_BooksService(...);
   *   $layers = $booksService->layers;
   *  </code>
   */
  class GFGS_Google_LayersServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_Layersummaries
     */
    public function listLayers($volumeId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_Layersummaries($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string source String to identify the originator of this request.
     * @opt_param string contentVersion The content version for the requested volume.
     * @return GFGS_Google_Layersummary
     */
    public function get($volumeId, $summaryId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_Layersummary($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_LayersAnnotationDataServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_Annotationsdata
     */
    public function listLayersAnnotationData($volumeId, $layerId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Annotationsdata($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string source String to identify the originator of this request.
     * @opt_param int w The requested pixel width for any images. If width is provided height must also be provided.
     * @return GFGS_Google_Annotationdata
     */
    public function get($volumeId, $layerId, $annotationDataId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Annotationdata($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_LayersVolumeAnnotationsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_Volumeannotations
     */
    public function listLayersVolumeAnnotations($volumeId, $layerId, $contentVersion, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Volumeannotations($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string locale The locale information for the data. ISO-639-1 language and ISO-3166-1 country code. Ex: 'en_US'.
     * @opt_param string source String to identify the originator of this request.
     * @return GFGS_Google_Volumeannotation
     */
    public function get($volumeId, $layerId, $annotationId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Volumeannotation($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_BookshelvesServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @opt_param string source String to identify the originator of this request.
     * @return GFGS_Google_Bookshelves
     */
    public function listBookshelves($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Bookshelves($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($userId, $shelf, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Bookshelf($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_BookshelvesVolumesServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listBookshelvesVolumes($userId, $shelf, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Volumes($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_MyconfigServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @opt_param string source String to identify the originator of this request.
     * @return GFGS_Google_DownloadAccesses
     */
    public function releaseDownloadAccess($volumeIds, $cpksver, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_DownloadAccesses($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @opt_param string locale ISO-639-1, ISO-3166-1 codes for message localization, i.e. en_US.
     * @return GFGS_Google_RequestAccess
     */
    public function requestAccess($source, $volumeId, $nonce, $cpksver, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_RequestAccess($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_VolumesServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function get($volumeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Volume($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_VolumesAssociatedServiceResource extends GFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class GFGS_Google_MylibraryServiceResource extends GFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class GFGS_Google_MylibraryBookshelvesServiceResource extends GFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class GFGS_Google_MylibraryBookshelvesVolumesServiceResource extends GFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class GFGS_Google_MylibraryReadingpositionsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_ReadingPosition
     */
    public function get($volumeId, $optParams = array()) {
      $params = array('volumeId' => $volumeId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_ReadingPosition($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_MylibraryAnnotationsServiceResource extends GFGS_Google_ServiceResource {


    /**
     * Inserts a new annotation. (annotations.insert)
     *
     * @param GFGS_Google_Annotation $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param string source String to identify the originator of this request.
     * @return GFGS_Google_Annotation
     */
    public function insert(GFGS_Google_Annotation $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Annotation($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GFGS_Google_Annotations
     */
    public function listMylibraryAnnotations($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Annotations($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GFGS_Google_Annotation
     */
    public function update($annotationId, GFGS_Google_Annotation $postBody, $optParams = array()) {
 ...
 * @author Google, Inc.
 */
class GFGS_Google_BooksService extends GFGS_Google_Service {
  public $layers;
...
class GFGS_Google_Annotation extends GFGS_Google_Model {
  ...
  public function setCurrentVersionRanges(GFGS_Google_AnnotationCurrentVersionRanges $currentVersionRanges) {
  ...
  public function setClientVersionRanges(GFGS_Google_AnnotationClientVersionRanges $clientVersionRanges) {
...
class GFGS_Google_AnnotationClientVersionRanges extends GFGS_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'GFGS_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
  protected $__cfiRangeType = 'GFGS_Google_BooksAnnotationsRange';
  protected $__cfiRangeDataType = '';
  public $cfiRange;
  protected $__gbImageRangeType = 'GFGS_Google_BooksAnnotationsRange';
  ...
  public function setGbTextRange(GFGS_Google_BooksAnnotationsRange $gbTextRange) {
    $this->gbTextRange = $gbTextRange;
  }
  public function getGbTextRange() {
    return $this->gbTextRange;
  }
  public function setCfiRange(GFGS_Google_BooksAnnotationsRange $cfiRange) {
    $this->cfiRange = $cfiRange;
  }
  public function getCfiRange() {
    return $this->cfiRange;
  }
  public function setGbImageRange(GFGS_Google_BooksAnnotationsRange $gbImageRange) {
...
class GFGS_Google_AnnotationCurrentVersionRanges extends GFGS_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'GFGS_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
...
class GFGS_Google_Annotationdata extends GFGS_Google_Model {
  ...
  public $encoded_data;
  public $layerId;
  protected $__dataType = 'GFGS_Google_BooksLayerGeoData';
  ...
  public function setData(GFGS_Google_BooksLayerGeoData $data) {
    $this->data = $data;
  }
  public function getData() {
    return $this->data;
...
class GFGS_Google_Annotations extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Annotation';
  ...
  public function setItems(/* array(GFGS_Google_Annotation) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Annotation', __METHOD__);
    $this->items = $items;
  }
...
class GFGS_Google_Annotationsdata extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Annotationdata';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(GFGS_Google_Annotationdata) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Annotationdata', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_BooksAnnotationsRange extends GFGS_Google_Model {
...
class GFGS_Google_BooksLayerGeoData extends GFGS_Google_Model {
  protected $__geoType = 'GFGS_Google_BooksLayerGeoDataGeo';
  protected $__geoDataType = '';
  public $geo;
  protected $__commonType = 'GFGS_Google_BooksLayerGeoDataCommon';
  protected $__commonDataType = '';
  public $common;
  public function setGeo(GFGS_Google_BooksLayerGeoDataGeo $geo) {
    $this->geo = $geo;
  }
  public function getGeo() {
    return $this->geo;
  }
  public function setCommon(GFGS_Google_BooksLayerGeoDataCommon $common) {
    $this->common = $common;
  }
...
class GFGS_Google_BooksLayerGeoDataCommon extends GFGS_Google_Model {
  public $lang;
...
class GFGS_Google_BooksLayerGeoDataGeo extends GFGS_Google_Model {
  public $countryCode;
  public $title;
  public $zoom;
  public $longitude;
  public $mapType;
  public $latitude;
  protected $__boundaryType = 'GFGS_Google_BooksLayerGeoDataGeoBoundary';
  protected $__boundaryDataType = 'array';
  public $boundary;
  protected $__viewportType = 'GFGS_Google_BooksLayerGeoDataGeoViewport';
  ...
  public function setBoundary(/* array(GFGS_Google_BooksLayerGeoDataGeoBoundary) */ $boundary) {
    $this->assertIsArray($boundary, 'GFGS_Google_BooksLayerGeoDataGeoBoundary', __METHOD__);
    $this->boundary = $boundary;
  }
  public function getBoundary() {
    return $this->boundary;
  }
  public function setViewport(GFGS_Google_BooksLayerGeoDataGeoViewport $viewport) {
...
class GFGS_Google_BooksLayerGeoDataGeoBoundary extends GFGS_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class GFGS_Google_BooksLayerGeoDataGeoViewport extends GFGS_Google_Model {
  protected $__loType = 'GFGS_Google_BooksLayerGeoDataGeoViewportLo';
  protected $__loDataType = '';
  public $lo;
  protected $__hiType = 'GFGS_Google_BooksLayerGeoDataGeoViewportHi';
  protected $__hiDataType = '';
  public $hi;
  public function setLo(GFGS_Google_BooksLayerGeoDataGeoViewportLo $lo) {
    $this->lo = $lo;
  }
  public function getLo() {
    return $this->lo;
  }
  public function setHi(GFGS_Google_BooksLayerGeoDataGeoViewportHi $hi) {
    $this->hi = $hi;
  }
...
class GFGS_Google_BooksLayerGeoDataGeoViewportHi extends GFGS_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class GFGS_Google_BooksLayerGeoDataGeoViewportLo extends GFGS_Google_Model {
  public $latitude;
  public $longitude;
  public function setLatitude($latitude) {
    $this->latitude = $latitude;
...
class GFGS_Google_Bookshelf extends GFGS_Google_Model {
  public $kind;
  public $description;
  public $created;
  public $volumeCount;
...
class GFGS_Google_Bookshelves extends GFGS_Google_Model {
  protected $__itemsType = 'GFGS_Google_Bookshelf';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(GFGS_Google_Bookshelf) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Bookshelf', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_ConcurrentAccessRestriction extends GFGS_Google_Model {
  public $nonce;
  public $kind;
  public $restricted;
  public $volumeId;
...
class GFGS_Google_DownloadAccessRestriction extends GFGS_Google_Model {
  public $nonce;
  public $kind;
  public $justAcquired;
...
class GFGS_Google_DownloadAccesses extends GFGS_Google_Model {
  protected $__downloadAccessListType = 'GFGS_Google_DownloadAccessRestriction';
  protected $__downloadAccessListDataType = 'array';
  public $downloadAccessList;
  public $kind;
  public function setDownloadAccessList(/* array(GFGS_Google_DownloadAccessRestriction) */ $downloadAccessList) {
    $this->assertIsArray($downloadAccessList, 'GFGS_Google_DownloadAccessRestriction', __METHOD__);
...
class GFGS_Google_Layersummaries extends GFGS_Google_Model {
  public $totalItems;
  protected $__itemsType = 'GFGS_Google_Layersummary';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(GFGS_Google_Layersummary) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Layersummary', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Layersummary extends GFGS_Google_Model {
  public $kind;
...
class GFGS_Google_ReadingPosition extends GFGS_Google_Model {
  public $kind;
...
class GFGS_Google_RequestAccess extends GFGS_Google_Model {
  protected $__downloadAccessType = 'GFGS_Google_DownloadAccessRestriction';
  protected $__downloadAccessDataType = '';
  public $downloadAccess;
  public $kind;
  protected $__concurrentAccessType = 'GFGS_Google_ConcurrentAccessRestriction';
  protected $__concurrentAccessDataType = '';
  public $concurrentAccess;
  public function setDownloadAccess(GFGS_Google_DownloadAccessRestriction $downloadAccess) {
  ...
  public function setConcurrentAccess(GFGS_Google_ConcurrentAccessRestriction $concurrentAccess) {
...
class GFGS_Google_Review extends GFGS_Google_Model {
  public $rating;
  public $kind;
  protected $__authorType = 'GFGS_Google_ReviewAuthor';
  protected $__authorDataType = '';
  public $author;
  public $title;
  public $volumeId;
  public $content;
  protected $__sourceType = 'GFGS_Google_ReviewSource';
  ...
  public function setAuthor(GFGS_Google_ReviewAuthor $author) {
    $this->author = $author;
  }
  ...
  public function setSource(GFGS_Google_ReviewSource $source) {
    $this->source = $source;
  }
  public function getSource() {
    return $this->source;
...
class GFGS_Google_ReviewAuthor extends GFGS_Google_Model {
  public $displayName;
...
class GFGS_Google_ReviewSource extends GFGS_Google_Model {
...
class GFGS_Google_Volume extends GFGS_Google_Model {
  public $kind;
  protected $__accessInfoType = 'GFGS_Google_VolumeAccessInfo';
  protected $__accessInfoDataType = '';
  public $accessInfo;
  protected $__searchInfoType = 'GFGS_Google_VolumeSearchInfo';
  protected $__searchInfoDataType = '';
  public $searchInfo;
  protected $__saleInfoType = 'GFGS_Google_VolumeSaleInfo';
  protected $__saleInfoDataType = '';
  public $saleInfo;
  public $etag;
  protected $__userInfoType = 'GFGS_Google_VolumeUserInfo';
  protected $__userInfoDataType = '';
  public $userInfo;
  protected $__volumeInfoType = 'GFGS_Google_VolumeVolumeInfo';
  ...
  public function setAccessInfo(GFGS_Google_VolumeAccessInfo $accessInfo) {
    $this->accessInfo = $accessInfo;
  }
  public function getAccessInfo() {
    return $this->accessInfo;
  }
  public function setSearchInfo(GFGS_Google_VolumeSearchInfo $searchInfo) {
    $this->searchInfo = $searchInfo;
  }
  public function getSearchInfo() {
    return $this->searchInfo;
  }
  public function setSaleInfo(GFGS_Google_VolumeSaleInfo $saleInfo) {
  ...
  public function setUserInfo(GFGS_Google_VolumeUserInfo $userInfo) {
    $this->userInfo = $userInfo;
  }
  public function getUserInfo() {
    return $this->userInfo;
  }
  public function setVolumeInfo(GFGS_Google_VolumeVolumeInfo $volumeInfo) {
...
class GFGS_Google_VolumeAccessInfo extends GFGS_Google_Model {
  ...
  protected $__pdfType = 'GFGS_Google_VolumeAccessInfoPdf';
  protected $__pdfDataType = '';
  public $pdf;
  public $viewability;
  protected $__epubType = 'GFGS_Google_VolumeAccessInfoEpub';
  ...
  public function setPdf(GFGS_Google_VolumeAccessInfoPdf $pdf) {
    $this->pdf = $pdf;
  }
  ...
  public function setEpub(GFGS_Google_VolumeAccessInfoEpub $epub) {
    $this->epub = $epub;
  }
...
class GFGS_Google_VolumeAccessInfoEpub extends GFGS_Google_Model {
  public $isAvailable;
  public $downloadLink;
  public $acsTokenLink;
...
class GFGS_Google_VolumeAccessInfoPdf extends GFGS_Google_Model {
  public $isAvailable;
  public $downloadLink;
  public $acsTokenLink;
  public function setIsAvailable($isAvailable) {
...
class GFGS_Google_VolumeSaleInfo extends GFGS_Google_Model {
  public $country;
  protected $__retailPriceType = 'GFGS_Google_VolumeSaleInfoRetailPrice';
  ...
  public $buyLink;
  public $onSaleDate;
  protected $__listPriceType = 'GFGS_Google_VolumeSaleInfoListPrice';
  ...
  public function setRetailPrice(GFGS_Google_VolumeSaleInfoRetailPrice $retailPrice) {
  ...
  public function setListPrice(GFGS_Google_VolumeSaleInfoListPrice $listPrice) {
...
class GFGS_Google_VolumeSaleInfoListPrice extends GFGS_Google_Model {
  public $amount;
  public $currencyCode;
...
class GFGS_Google_VolumeSaleInfoRetailPrice extends GFGS_Google_Model {
  public $amount;
  public $currencyCode;
  public function setAmount($amount) {
    $this->amount = $amount;
...
class GFGS_Google_VolumeSearchInfo extends GFGS_Google_Model {
  public $textSnippet;
...
class GFGS_Google_VolumeUserInfo extends GFGS_Google_Model {
  public $isInMyBooks;
  public $updated;
  protected $__reviewType = 'GFGS_Google_Review';
  protected $__reviewDataType = '';
  public $review;
  public $isPurchased;
  protected $__readingPositionType = 'GFGS_Google_ReadingPosition';
  ...
  public function setReview(GFGS_Google_Review $review) {
    $this->review = $review;
  }
  ...
  public function setReadingPosition(GFGS_Google_ReadingPosition $readingPosition) {
...
class GFGS_Google_VolumeVolumeInfo extends GFGS_Google_Model {
  public $publisher;
  public $subtitle;
  public $description;
  public $language;
  public $pageCount;
  protected $__imageLinksType = 'GFGS_Google_VolumeVolumeInfoImageLinks';
  ...
  public $ratingsCount;
  public $mainCategory;
  protected $__dimensionsType = 'GFGS_Google_VolumeVolumeInfoDimensions';
  protected $__dimensionsDataType = '';
  public $dimensions;
  public $contentVersion;
  protected $__industryIdentifiersType = 'GFGS_Google_VolumeVolumeInfoIndustryIdentifiers';
  ...
  public function setImageLinks(GFGS_Google_VolumeVolumeInfoImageLinks $imageLinks) {
  ...
  public function setDimensions(GFGS_Google_VolumeVolumeInfoDimensions $dimensions) {
  ...
  public function setIndustryIdentifiers(/* array(GFGS_Google_VolumeVolumeInfoIndustryIdentifiers) */ $industryIdentifiers) {
    $this->assertIsArray($industryIdentifiers, 'GFGS_Google_VolumeVolumeInfoIndustryIdentifiers', __METHOD__);
...
class GFGS_Google_VolumeVolumeInfoDimensions extends GFGS_Google_Model {
  public $width;
  public $thickness;
  public $height;
...
class GFGS_Google_VolumeVolumeInfoImageLinks extends GFGS_Google_Model {
  public $medium;
...
class GFGS_Google_VolumeVolumeInfoIndustryIdentifiers extends GFGS_Google_Model {
  public $identifier;
  public $type;
...
class GFGS_Google_Volumeannotation extends GFGS_Google_Model {
  public $annotationType;
  public $kind;
  public $updated;
  public $deleted;
  protected $__contentRangesType = 'GFGS_Google_VolumeannotationContentRanges';
  ...
  public function setContentRanges(GFGS_Google_VolumeannotationContentRanges $contentRanges) {
...
class GFGS_Google_VolumeannotationContentRanges extends GFGS_Google_Model {
  public $contentVersion;
  protected $__gbTextRangeType = 'GFGS_Google_BooksAnnotationsRange';
  protected $__gbTextRangeDataType = '';
  public $gbTextRange;
...
class GFGS_Google_Volumeannotations extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Volumeannotation';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $totalItems;
  ...
  public function setItems(/* array(GFGS_Google_Volumeannotation) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Volumeannotation', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Volumes extends GFGS_Google_Model {
  public $totalItems;
  protected $__itemsType = 'GFGS_Google_Volume';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setTotalItems($totalItems) {
  ...
  public function setItems(/* array(GFGS_Google_Volume) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Volume', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
