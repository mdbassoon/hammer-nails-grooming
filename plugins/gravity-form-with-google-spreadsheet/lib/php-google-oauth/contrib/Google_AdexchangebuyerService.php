 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adexchangebuyerService = new GFGS_Google_AdexchangebuyerService(...);
  ...
  class GFGS_Google_AccountsServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_AccountsList
     */
    public function listAccounts($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_AccountsList($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param int $id The account id
     * @param GFGS_Google_Account $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Account
     */
    public function patch($id, GFGS_Google_Account $postBody, $optParams = array()) {
     ...
     * @return GFGS_Google_Account
     */
    public function update($id, GFGS_Google_Account $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class GFGS_Google_CreativesServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function get($accountId, $buyerCreativeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Creative($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param GFGS_Google_Creative $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Creative
     */
    public function insert( GFGS_Google_Creative $postBody, $optParams = array()) {
     ...
     * @return GFGS_Google_CreativesList
     */
    public function listCreatives($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CreativesList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_DirectDealsServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function get($id, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_DirectDeal($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_DirectDealsList
     */
    public function listDirectDeals($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_DirectDealsList($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class GFGS_Google_AdexchangebuyerService extends GFGS_Google_Service {
  public $accounts;
  public $creatives;
  public $directDeals;
  /**
...
class GFGS_Google_Account extends GFGS_Google_Model {
  ...
  public function setBidderLocation(/* array(GFGS_Google_AccountBidderLocation) */ $bidderLocation) {
    $this->assertIsArray($bidderLocation, 'GFGS_Google_AccountBidderLocation', __METHOD__);
...
class GFGS_Google_AccountBidderLocation extends GFGS_Google_Model {
  public $maximumQps;
  public $region;
  public $url;
...
class GFGS_Google_AccountsList extends GFGS_Google_Model {
...
class GFGS_Google_Creative extends GFGS_Google_Model {
  public $HTMLSnippet;
  public $accountId;
  public $advertiserId;
...
class GFGS_Google_CreativesList extends GFGS_Google_Model {
  protected $__itemsType = 'GFGS_Google_Creative';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  public function setItems(/* array(GFGS_Google_Creative) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Creative', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_DirectDeal extends GFGS_Google_Model {
  public $accountId;
  public $advertiser;
  public $currencyCode;
  public $endTime;
...
class GFGS_Google_DirectDealsList extends GFGS_Google_Model {
  protected $__directDealsType = 'GFGS_Google_DirectDeal';
  protected $__directDealsDataType = 'array';
  public $directDeals;
  public $kind;
  public function setDirectDeals(/* array(GFGS_Google_DirectDeal) */ $directDeals) {
    $this->assertIsArray($directDeals, 'GFGS_Google_DirectDeal', __METHOD__);
