 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $predictionService = new GFGS_Google_PredictionService(...);
   *   $trainedmodels = $predictionService->trainedmodels;
   *  </code>
   */
  class GFGS_Google_TrainedmodelsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @param GFGS_Google_Input $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Output
     */
    public function predict($id, GFGS_Google_Input $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('predict', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Output($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param GFGS_Google_Training $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Training
     */
    public function insert(GFGS_Google_Training $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Training($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $id The unique name for the predictive model.
     * @param GFGS_Google_Update $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Training
     */
    public function update($id, GFGS_Google_Update $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class GFGS_Google_HostedmodelsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_Output
     */
    public function predict($hostedModelName, GFGS_Google_Input $postBody, $optParams = array()) {
 ...
 * @author Google, Inc.
 */
class GFGS_Google_PredictionService extends GFGS_Google_Service {
...
class GFGS_Google_InputInput extends GFGS_Google_Model {
  public $csvInstance;
...
class GFGS_Google_Output extends GFGS_Google_Model {
  public $kind;
  public $outputLabel;
  public $id;
  protected $__outputMultiType = 'GFGS_Google_OutputOutputMulti';
  ...
  public function setOutputMulti(/* array(GFGS_Google_OutputOutputMulti) */ $outputMulti) {
    $this->assertIsArray($outputMulti, 'GFGS_Google_OutputOutputMulti', __METHOD__);
...
class GFGS_Google_OutputOutputMulti extends GFGS_Google_Model {
  public $score;
  public $label;
...
class GFGS_Google_Training extends GFGS_Google_Model {
  public $kind;
  public $storageDataLocation;
  public $storagePMMLModelLocation;
  protected $__dataAnalysisType = 'GFGS_Google_TrainingDataAnalysis';
  protected $__dataAnalysisDataType = '';
  public $dataAnalysis;
  public $trainingStatus;
  protected $__modelInfoType = 'GFGS_Google_TrainingModelInfo';
  ...
  public function setDataAnalysis(GFGS_Google_TrainingDataAnalysis $dataAnalysis) {
  ...
  public function setModelInfo(GFGS_Google_TrainingModelInfo $modelInfo) {
...
class GFGS_Google_TrainingDataAnalysis extends GFGS_Google_Model {
  public $warnings;
...
class GFGS_Google_TrainingModelInfo extends GFGS_Google_Model {
...
class GFGS_Google_Update extends GFGS_Google_Model {
  public $csvInstance;
  public $label;
  public function setCsvInstance(/* array(Google_object) */ $csvInstance) {
    $this->assertIsArray($csvInstance, 'Google_object', __METHOD__);
