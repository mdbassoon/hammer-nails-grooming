 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $analyticsService = new GFGS_Google_AnalyticsService(...);
   *   $management = $analyticsService->management;
   *  </code>
   */
  class GFGS_Google_ManagementServiceResource extends GFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class GFGS_Google_ManagementDailyUploadsServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_DailyUploads
     */
    public function listManagementDailyUploads($accountId, $webPropertyId, $customDataSourceId, $start_date, $end_date, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_DailyUploads($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GFGS_Google_DailyUploadAppend
     */
    public function upload($accountId, $webPropertyId, $customDataSourceId, $date, $appendNumber, $type, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_DailyUploadAppend($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_ManagementSegmentsServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listManagementSegments($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Segments($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_ManagementProfilesServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listManagementProfiles($accountId, $webPropertyId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Profiles($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_ManagementCustomDataSourcesServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_CustomDataSources
     */
    public function listManagementCustomDataSources($accountId, $webPropertyId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_CustomDataSources($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_ManagementGoalsServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listManagementGoals($accountId, $webPropertyId, $profileId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Goals($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_ManagementAccountsServiceResource extends GFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class GFGS_Google_ManagementWebpropertiesServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @opt_param int start-index An index of the first entity to retrieve. Use this parameter as a pagination mechanism along with the max-results parameter.
     * @return GFGS_Google_Webproperties
     */
    public function listManagementWebproperties($accountId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Webproperties($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_DataServiceResource extends GFGS_Google_ServiceResource {
   ...
   *  </code>
   */
  class GFGS_Google_DataMcfServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function get($ids, $start_date, $end_date, $metrics, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_McfData($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_DataGaServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function get($ids, $start_date, $end_date, $metrics, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_GaData($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class GFGS_Google_AnalyticsService extends GFGS_Google_Service {
...
class GFGS_Google_AccountChildLink extends GFGS_Google_Model {
  public $href;
  public $type;
...
class GFGS_Google_CustomDataSource extends GFGS_Google_Model {
  public $kind;
  public $description;
  public $created;
  ...
  public $updated;
  public $name;
  protected $__childLinkType = 'GFGS_Google_CustomDataSourceChildLink';
  protected $__childLinkDataType = '';
  public $childLink;
  public $webPropertyId;
  protected $__parentLinkType = 'GFGS_Google_CustomDataSourceParentLink';
  ...
  public function setChildLink(GFGS_Google_CustomDataSourceChildLink $childLink) {
    $this->childLink = $childLink;
  }
  public function getChildLink() {
    return $this->childLink;
  ...
  public function setParentLink(GFGS_Google_CustomDataSourceParentLink $parentLink) {
...
class GFGS_Google_CustomDataSourceChildLink extends GFGS_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class GFGS_Google_CustomDataSourceParentLink extends GFGS_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class GFGS_Google_CustomDataSources extends GFGS_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'GFGS_Google_CustomDataSource';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(GFGS_Google_CustomDataSource) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_CustomDataSource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_DailyUpload extends GFGS_Google_Model {
  protected $__recentChangesType = 'GFGS_Google_DailyUploadRecentChanges';
  ...
  public $webPropertyId;
  public $createdTime;
  protected $__parentLinkType = 'GFGS_Google_DailyUploadParentLink';
  protected $__parentLinkDataType = '';
  public $parentLink;
  public $selfLink;
  public $accountId;
  public function setRecentChanges(/* array(GFGS_Google_DailyUploadRecentChanges) */ $recentChanges) {
    $this->assertIsArray($recentChanges, 'GFGS_Google_DailyUploadRecentChanges', __METHOD__);
  ...
  public function setParentLink(GFGS_Google_DailyUploadParentLink $parentLink) {
    $this->parentLink = $parentLink;
  }
  public function getParentLink() {
    return $this->parentLink;
...
class GFGS_Google_DailyUploadAppend extends GFGS_Google_Model {
  public $kind;
  public $customDataSourceId;
  public $appendNumber;
  public $webPropertyId;
...
class GFGS_Google_DailyUploadParentLink extends GFGS_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class GFGS_Google_DailyUploadRecentChanges extends GFGS_Google_Model {
  public $change;
  public $time;
...
class GFGS_Google_DailyUploads extends GFGS_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'GFGS_Google_DailyUpload';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(GFGS_Google_DailyUpload) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_DailyUpload', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_GaData extends GFGS_Google_Model {
  public $kind;
  public $rows;
  ...
  public $nextLink;
  public $id;
  protected $__queryType = 'GFGS_Google_GaDataQuery';
  protected $__queryDataType = '';
  public $query;
  public $previousLink;
  protected $__profileInfoType = 'GFGS_Google_GaDataProfileInfo';
  protected $__profileInfoDataType = '';
  public $profileInfo;
  protected $__columnHeadersType = 'GFGS_Google_GaDataColumnHeaders';
  ...
  public function setQuery(GFGS_Google_GaDataQuery $query) {
    $this->query = $query;
  }
  ...
  public function setProfileInfo(GFGS_Google_GaDataProfileInfo $profileInfo) {
    $this->profileInfo = $profileInfo;
  }
  public function getProfileInfo() {
    return $this->profileInfo;
  }
  public function setColumnHeaders(/* array(GFGS_Google_GaDataColumnHeaders) */ $columnHeaders) {
    $this->assertIsArray($columnHeaders, 'GFGS_Google_GaDataColumnHeaders', __METHOD__);
...
class GFGS_Google_GaDataColumnHeaders extends GFGS_Google_Model {
  public $dataType;
  public $columnType;
  public $name;
...
class GFGS_Google_GaDataProfileInfo extends GFGS_Google_Model {
  public $webPropertyId;
...
class GFGS_Google_GaDataQuery extends GFGS_Google_Model {
  public $max_results;
  public $sort;
  public $dimensions;
  public $start_date;
...
class GFGS_Google_Goal extends GFGS_Google_Model {
  public $kind;
  protected $__visitTimeOnSiteDetailsType = 'GFGS_Google_GoalVisitTimeOnSiteDetails';
  protected $__visitTimeOnSiteDetailsDataType = '';
  public $visitTimeOnSiteDetails;
  public $name;
  public $created;
  protected $__urlDestinationDetailsType = 'GFGS_Google_GoalUrlDestinationDetails';
  protected $__urlDestinationDetailsDataType = '';
  public $urlDestinationDetails;
  public $updated;
  public $value;
  protected $__visitNumPagesDetailsType = 'GFGS_Google_GoalVisitNumPagesDetails';
  protected $__visitNumPagesDetailsDataType = '';
  public $visitNumPagesDetails;
  public $internalWebPropertyId;
  protected $__eventDetailsType = 'GFGS_Google_GoalEventDetails';
  protected $__eventDetailsDataType = '';
  public $eventDetails;
  public $webPropertyId;
  public $active;
  public $profileId;
  protected $__parentLinkType = 'GFGS_Google_GoalParentLink';
  protected $__parentLinkDataType = '';
  public $parentLink;
  public $type;
  public $id;
  ...
  public function setVisitTimeOnSiteDetails(GFGS_Google_GoalVisitTimeOnSiteDetails $visitTimeOnSiteDetails) {
  ...
  public function setUrlDestinationDetails(GFGS_Google_GoalUrlDestinationDetails $urlDestinationDetails) {
  ...
  public function setVisitNumPagesDetails(GFGS_Google_GoalVisitNumPagesDetails $visitNumPagesDetails) {
  ...
  public function setEventDetails(GFGS_Google_GoalEventDetails $eventDetails) {
  ...
  public function setParentLink(GFGS_Google_GoalParentLink $parentLink) {
    $this->parentLink = $parentLink;
  }
  public function getParentLink() {
    return $this->parentLink;
...
class GFGS_Google_GoalEventDetails extends GFGS_Google_Model {
  protected $__eventConditionsType = 'GFGS_Google_GoalEventDetailsEventConditions';
  protected $__eventConditionsDataType = 'array';
  public $eventConditions;
  public $useEventValue;
  public function setEventConditions(/* array(GFGS_Google_GoalEventDetailsEventConditions) */ $eventConditions) {
    $this->assertIsArray($eventConditions, 'GFGS_Google_GoalEventDetailsEventConditions', __METHOD__);
...
class GFGS_Google_GoalEventDetailsEventConditions extends GFGS_Google_Model {
  public $type;
  public $matchType;
  public $expression;
...
class GFGS_Google_GoalParentLink extends GFGS_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class GFGS_Google_GoalUrlDestinationDetails extends GFGS_Google_Model {
  public $url;
  public $caseSensitive;
  public $matchType;
  protected $__stepsType = 'GFGS_Google_GoalUrlDestinationDetailsSteps';
  ...
  public function setSteps(/* array(GFGS_Google_GoalUrlDestinationDetailsSteps) */ $steps) {
    $this->assertIsArray($steps, 'GFGS_Google_GoalUrlDestinationDetailsSteps', __METHOD__);
    $this->steps = $steps;
  }
...
class GFGS_Google_GoalUrlDestinationDetailsSteps extends GFGS_Google_Model {
  public $url;
  public $name;
  public $number;
  public function setUrl($url) {
...
class GFGS_Google_GoalVisitNumPagesDetails extends GFGS_Google_Model {
  public $comparisonType;
  public $comparisonValue;
  public function setComparisonType($comparisonType) {
    $this->comparisonType = $comparisonType;
...
class GFGS_Google_GoalVisitTimeOnSiteDetails extends GFGS_Google_Model {
  public $comparisonType;
  public $comparisonValue;
  public function setComparisonType($comparisonType) {
    $this->comparisonType = $comparisonType;
...
class GFGS_Google_Goals extends GFGS_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'GFGS_Google_Goal';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(GFGS_Google_Goal) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Goal', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_McfData extends GFGS_Google_Model {
  public $kind;
  protected $__rowsType = 'GFGS_Google_McfDataRows';
  ...
  public $nextLink;
  public $id;
  protected $__queryType = 'GFGS_Google_McfDataQuery';
  protected $__queryDataType = '';
  public $query;
  public $previousLink;
  protected $__profileInfoType = 'GFGS_Google_McfDataProfileInfo';
  protected $__profileInfoDataType = '';
  public $profileInfo;
  protected $__columnHeadersType = 'GFGS_Google_McfDataColumnHeaders';
  protected $__columnHeadersDataType = 'array';
  public $columnHeaders;
  public $selfLink;
  public function setKind($kind) {
  ...
  public function setRows(/* array(GFGS_Google_McfDataRows) */ $rows) {
    $this->assertIsArray($rows, 'GFGS_Google_McfDataRows', __METHOD__);
    $this->rows = $rows;
  }
  public function getRows() {
    return $this->rows;
  ...
  public function setQuery(GFGS_Google_McfDataQuery $query) {
    $this->query = $query;
  }
  public function getQuery() {
    return $this->query;
  ...
  public function setProfileInfo(GFGS_Google_McfDataProfileInfo $profileInfo) {
    $this->profileInfo = $profileInfo;
  }
  public function getProfileInfo() {
    return $this->profileInfo;
  }
  public function setColumnHeaders(/* array(GFGS_Google_McfDataColumnHeaders) */ $columnHeaders) {
    $this->assertIsArray($columnHeaders, 'GFGS_Google_McfDataColumnHeaders', __METHOD__);
    $this->columnHeaders = $columnHeaders;
  }
  public function getColumnHeaders() {
    return $this->columnHeaders;
...
class GFGS_Google_McfDataColumnHeaders extends GFGS_Google_Model {
  public $dataType;
  public $columnType;
  public $name;
  public function setDataType($dataType) {
...
class GFGS_Google_McfDataProfileInfo extends GFGS_Google_Model {
  public $webPropertyId;
  public $internalWebPropertyId;
  public $tableId;
  public $profileId;
...
class GFGS_Google_McfDataQuery extends GFGS_Google_Model {
  public $max_results;
  public $sort;
  public $dimensions;
  public $start_date;
...
class GFGS_Google_McfDataRows extends GFGS_Google_Model {
  public $primitiveValue;
  protected $__conversionPathValueType = 'GFGS_Google_McfDataRowsConversionPathValue';
  ...
  public function setConversionPathValue(/* array(GFGS_Google_McfDataRowsConversionPathValue) */ $conversionPathValue) {
    $this->assertIsArray($conversionPathValue, 'GFGS_Google_McfDataRowsConversionPathValue', __METHOD__);
...
class GFGS_Google_McfDataRowsConversionPathValue extends GFGS_Google_Model {
  public $nodeValue;
...
class GFGS_Google_Profile extends GFGS_Google_Model {
  public $defaultPage;
  public $kind;
  ...
  public $currency;
  public $internalWebPropertyId;
  protected $__childLinkType = 'GFGS_Google_ProfileChildLink';
  protected $__childLinkDataType = '';
  public $childLink;
  public $eCommerceTracking;
  public $timezone;
  public $siteSearchCategoryParameters;
  protected $__parentLinkType = 'GFGS_Google_ProfileParentLink';
  protected $__parentLinkDataType = '';
  public $parentLink;
  public $id;
  public $selfLink;
  ...
  public function setChildLink(GFGS_Google_ProfileChildLink $childLink) {
    $this->childLink = $childLink;
  }
  public function getChildLink() {
    return $this->childLink;
  ...
  public function setParentLink(GFGS_Google_ProfileParentLink $parentLink) {
    $this->parentLink = $parentLink;
  }
  public function getParentLink() {
    return $this->parentLink;
...
class GFGS_Google_ProfileChildLink extends GFGS_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class GFGS_Google_ProfileParentLink extends GFGS_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class GFGS_Google_Profiles extends GFGS_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'GFGS_Google_Profile';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(GFGS_Google_Profile) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Profile', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Segment extends GFGS_Google_Model {
  public $definition;
  public $kind;
  public $segmentId;
  public $created;
...
class GFGS_Google_Segments extends GFGS_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'GFGS_Google_Segment';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(GFGS_Google_Segment) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Segment', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Webproperties extends GFGS_Google_Model {
  public $username;
  public $kind;
  protected $__itemsType = 'GFGS_Google_Webproperty';
  protected $__itemsDataType = 'array';
  public $items;
  public $itemsPerPage;
  public $previousLink;
  ...
  public function setItems(/* array(GFGS_Google_Webproperty) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Webproperty', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Webproperty extends GFGS_Google_Model {
  public $kind;
  public $name;
  public $created;
  public $updated;
  public $websiteUrl;
  public $internalWebPropertyId;
  protected $__childLinkType = 'GFGS_Google_WebpropertyChildLink';
  protected $__childLinkDataType = '';
  public $childLink;
  protected $__parentLinkType = 'GFGS_Google_WebpropertyParentLink';
  protected $__parentLinkDataType = '';
  public $parentLink;
  public $id;
  public $selfLink;
  ...
  public function setChildLink(GFGS_Google_WebpropertyChildLink $childLink) {
    $this->childLink = $childLink;
  }
  public function getChildLink() {
    return $this->childLink;
  }
  public function setParentLink(GFGS_Google_WebpropertyParentLink $parentLink) {
    $this->parentLink = $parentLink;
  }
  public function getParentLink() {
    return $this->parentLink;
...
class GFGS_Google_WebpropertyChildLink extends GFGS_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
...
class GFGS_Google_WebpropertyParentLink extends GFGS_Google_Model {
  public $href;
  public $type;
  public function setHref($href) {
    $this->href = $href;
