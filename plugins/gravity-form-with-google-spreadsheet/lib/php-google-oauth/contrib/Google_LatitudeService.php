 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $latitudeService = new GFGS_Google_LatitudeService(...);
   *   $currentLocation = $latitudeService->currentLocation;
   *  </code>
   */
  class GFGS_Google_CurrentLocationServiceResource extends GFGS_Google_ServiceResource {


    /**
     * Updates or creates the user's current location. (currentLocation.insert)
     *
     * @param GFGS_Google_Location $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Location
     */
    public function insert(GFGS_Google_Location $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Location($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_LocationServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @return GFGS_Google_LocationFeed
     */
    public function listLocation($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_LocationFeed($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class GFGS_Google_LatitudeService extends GFGS_Google_Service {
...
class GFGS_Google_LocationFeed extends GFGS_Google_Model {
  protected $__itemsType = 'GFGS_Google_Location';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(GFGS_Google_Location) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Location', __METHOD__);
    $this->items = $items;
  }
