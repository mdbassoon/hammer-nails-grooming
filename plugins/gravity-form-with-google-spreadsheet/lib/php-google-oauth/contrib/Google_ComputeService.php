 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $computeService = new GFGS_Google_ComputeService(...);
   *   $operations = $computeService->operations;
   *  </code>
   */
  class GFGS_Google_OperationsServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function get($project, $operation, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_Operation($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GFGS_Google_OperationList
     */
    public function listOperations($project, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_OperationList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_KernelsServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listKernels($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_KernelList($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($project, $kernel, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Kernel($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_DisksServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param GFGS_Google_Disk $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Operation
     */
    public function insert($project, GFGS_Google_Disk $postBody, $optParams = array()) {
    ...
    public function get($project, $disk, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Disk($data);
      } else {
        return $data;
      }
    }
    ...
    public function listDisks($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_DiskList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_SnapshotsServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param GFGS_Google_Snapshot $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Operation
     */
    public function insert($project, GFGS_Google_Snapshot $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
    ...
    public function get($project, $snapshot, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Snapshot($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return GFGS_Google_SnapshotList
     */
    public function listSnapshots($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_SnapshotList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_ZonesServiceResource extends GFGS_Google_ServiceResource {
    ...
    public function listZones($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_ZoneList($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($project, $zone, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Zone($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_InstancesServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_SerialPortOutput
     */
    public function getSerialPortOutput($project, $instance, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new GFGS_Google_SerialPortOutput($data);
      } else {
        return $data;
      }
    }
    ...
    public function get($project, $instance, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Instance($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return GFGS_Google_InstanceList
     */
    public function listInstances($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_InstanceList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $instance Instance name.
     * @param string $network_interface Network interface name.
     * @param GFGS_Google_AccessConfig $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Operation
     */
    public function addAccessConfig($project, $instance, $network_interface, GFGS_Google_AccessConfig $postBody, $optParams = array()) {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param GFGS_Google_Instance $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Operation
     */
    public function insert($project, GFGS_Google_Instance $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class GFGS_Google_MachineTypesServiceResource extends GFGS_Google_ServiceResource {
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return GFGS_Google_MachineTypeList
     */
    public function listMachineTypes($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_MachineTypeList($data);
      } else {
        return $data;
      }
    }
     ...
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_MachineType
     */
    public function get($project, $machineType, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_MachineType($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_ImagesServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param GFGS_Google_Image $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Operation
     */
    public function insert($project, GFGS_Google_Image $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
    ...
    public function get($project, $image, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Image($data);
      } else {
        return $data;
      }
    }
    ...
    public function listImages($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_ImageList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class GFGS_Google_FirewallsServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param GFGS_Google_Firewall $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Operation
     */
    public function insert($project, GFGS_Google_Firewall $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
    ...
    public function get($project, $firewall, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Firewall($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return GFGS_Google_FirewallList
     */
    public function listFirewalls($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_FirewallList($data);
      } else {
        return $data;
      }
    }
     ...
     * @return GFGS_Google_Operation
     */
    public function update($project, $firewall, GFGS_Google_Firewall $postBody, $optParams = array()) {
     ...
     * @return GFGS_Google_Operation
     */
    public function patch($project, $firewall, GFGS_Google_Firewall $postBody, $optParams = array()) {
      $params = array('project' => $project, 'firewall' => $firewall, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class GFGS_Google_NetworksServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param GFGS_Google_Network $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Operation
     */
    public function insert($project, GFGS_Google_Network $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
    ...
    public function get($project, $network, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Network($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken Optional. Tag returned by a previous list request truncated by maxResults. Used to continue a previous list request.
     * @opt_param string maxResults Optional. Maximum count of results to be returned. Maximum and default value is 100.
     * @return GFGS_Google_NetworkList
     */
    public function listNetworks($project, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_NetworkList($data);
      } else {
        return $data;
      }
    }
  ...
  class GFGS_Google_ProjectsServiceResource extends GFGS_Google_ServiceResource {
     ...
     *
     * @param string $project Name of the project scoping this request.
     * @param GFGS_Google_Metadata $postBody
     * @param array $optParams Optional parameters.
     * @return GFGS_Google_Operation
     */
    public function setCommonInstanceMetadata($project, GFGS_Google_Metadata $postBody, $optParams = array()) {
      $params = array('project' => $project, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
    ...
    public function get($project, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new GFGS_Google_Project($data);
      } else {
        return $data;
      }
    }
 ...
 * @author Google, Inc.
 */
class GFGS_Google_ComputeService extends GFGS_Google_Service {
  public $operations;
  public $kernels;
  public $disks;
  public $snapshots;
...
class GFGS_Google_AttachedDisk extends GFGS_Google_Model {
  public $deviceName;
  public $kind;
  public $index;
  public $source;
...
class GFGS_Google_Disk extends GFGS_Google_Model {
  public $status;
...
class GFGS_Google_DiskList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Disk';
  ...
  public function setItems(/* array(GFGS_Google_Disk) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Disk', __METHOD__);
    $this->items = $items;
  }
...
class GFGS_Google_Firewall extends GFGS_Google_Model {
  public $kind;
  public $description;
  public $sourceTags;
  public $sourceRanges;
  public $network;
  public $targetTags;
  protected $__allowedType = 'GFGS_Google_FirewallAllowed';
  ...
  public function setAllowed(/* array(GFGS_Google_FirewallAllowed) */ $allowed) {
    $this->assertIsArray($allowed, 'GFGS_Google_FirewallAllowed', __METHOD__);
...
class GFGS_Google_FirewallAllowed extends GFGS_Google_Model {
  public $IPProtocol;
  public $ports;
...
class GFGS_Google_FirewallList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Firewall';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(GFGS_Google_Firewall) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Firewall', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Image extends GFGS_Google_Model {
  public $kind;
  public $description;
  protected $__rawDiskType = 'GFGS_Google_ImageRawDisk';
  protected $__rawDiskDataType = '';
  public $rawDisk;
  public $preferredKernel;
  protected $__diskSnapshotType = 'GFGS_Google_ImageDiskSnapshot';
  ...
  public function setRawDisk(GFGS_Google_ImageRawDisk $rawDisk) {
  ...
  public function setDiskSnapshot(GFGS_Google_ImageDiskSnapshot $diskSnapshot) {
...
class GFGS_Google_ImageDiskSnapshot extends GFGS_Google_Model {
  public $source;
  public function setSource($source) {
    $this->source = $source;
  }
...
class GFGS_Google_ImageList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Image';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(GFGS_Google_Image) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Image', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_ImageRawDisk extends GFGS_Google_Model {
...
class GFGS_Google_Instance extends GFGS_Google_Model {
  public $status;
  public $kind;
  public $machineType;
  public $description;
  ...
  public $tags;
  public $image;
  protected $__disksType = 'GFGS_Google_AttachedDisk';
  protected $__disksDataType = 'array';
  public $disks;
  public $name;
  public $statusMessage;
  protected $__serviceAccountsType = 'GFGS_Google_ServiceAccount';
  protected $__serviceAccountsDataType = 'array';
  public $serviceAccounts;
  protected $__networkInterfacesType = 'GFGS_Google_NetworkInterface';
  protected $__networkInterfacesDataType = 'array';
  public $networkInterfaces;
  public $creationTimestamp;
  public $id;
  public $selfLink;
  protected $__metadataType = 'GFGS_Google_Metadata';
  ...
  public function setDisks(/* array(GFGS_Google_AttachedDisk) */ $disks) {
    $this->assertIsArray($disks, 'GFGS_Google_AttachedDisk', __METHOD__);
    $this->disks = $disks;
  }
  ...
  public function setServiceAccounts(/* array(GFGS_Google_ServiceAccount) */ $serviceAccounts) {
    $this->assertIsArray($serviceAccounts, 'GFGS_Google_ServiceAccount', __METHOD__);
    $this->serviceAccounts = $serviceAccounts;
  }
  public function getServiceAccounts() {
    return $this->serviceAccounts;
  }
  public function setNetworkInterfaces(/* array(GFGS_Google_NetworkInterface) */ $networkInterfaces) {
    $this->assertIsArray($networkInterfaces, 'GFGS_Google_NetworkInterface', __METHOD__);
  ...
  public function setMetadata(GFGS_Google_Metadata $metadata) {
...
class GFGS_Google_InstanceList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Instance';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(GFGS_Google_Instance) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Instance', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Kernel extends GFGS_Google_Model {
  public $kind;
  public $description;
  public $creationTimestamp;
  public $id;
...
class GFGS_Google_KernelList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Kernel';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(GFGS_Google_Kernel) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Kernel', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_MachineType extends GFGS_Google_Model {
  public $guestCpus;
  public $imageSpaceGb;
  public $kind;
  protected $__ephemeralDisksType = 'GFGS_Google_MachineTypeEphemeralDisks';
  ...
  public function setEphemeralDisks(/* array(GFGS_Google_MachineTypeEphemeralDisks) */ $ephemeralDisks) {
    $this->assertIsArray($ephemeralDisks, 'GFGS_Google_MachineTypeEphemeralDisks', __METHOD__);
...
class GFGS_Google_MachineTypeEphemeralDisks extends GFGS_Google_Model {
  public $diskGb;
...
class GFGS_Google_MachineTypeList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_MachineType';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(GFGS_Google_MachineType) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_MachineType', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Metadata extends GFGS_Google_Model {
  protected $__itemsType = 'GFGS_Google_MetadataItems';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(GFGS_Google_MetadataItems) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_MetadataItems', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_MetadataItems extends GFGS_Google_Model {
  public $value;
  public $key;
...
class GFGS_Google_Network extends GFGS_Google_Model {
  public $kind;
  public $description;
  public $IPv4Range;
  public $gatewayIPv4;
...
class GFGS_Google_NetworkInterface extends GFGS_Google_Model {
  public $network;
  protected $__accessConfigsType = 'GFGS_Google_AccessConfig';
  ...
  public function setAccessConfigs(/* array(GFGS_Google_AccessConfig) */ $accessConfigs) {
    $this->assertIsArray($accessConfigs, 'GFGS_Google_AccessConfig', __METHOD__);
...
class GFGS_Google_NetworkList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Network';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(GFGS_Google_Network) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Network', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Operation extends GFGS_Google_Model {
  public $status;
  public $kind;
  public $name;
  public $startTime;
  ...
  public $user;
  protected $__errorType = 'GFGS_Google_OperationError';
  ...
  public function setError(GFGS_Google_OperationError $error) {
    $this->error = $error;
  }
...
class GFGS_Google_OperationError extends GFGS_Google_Model {
  protected $__errorsType = 'GFGS_Google_OperationErrorErrors';
  protected $__errorsDataType = 'array';
  public $errors;
  public function setErrors(/* array(GFGS_Google_OperationErrorErrors) */ $errors) {
    $this->assertIsArray($errors, 'GFGS_Google_OperationErrorErrors', __METHOD__);
    $this->errors = $errors;
  }
...
class GFGS_Google_OperationErrorErrors extends GFGS_Google_Model {
  public $message;
  public $code;
  public $location;
...
class GFGS_Google_OperationList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Operation';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(GFGS_Google_Operation) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Operation', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Project extends GFGS_Google_Model {
  public $kind;
  public $description;
  protected $__commonInstanceMetadataType = 'GFGS_Google_Metadata';
  protected $__commonInstanceMetadataDataType = '';
  public $commonInstanceMetadata;
  public $externalIpAddresses;
  protected $__quotasType = 'GFGS_Google_ProjectQuotas';
  ...
  public function setCommonInstanceMetadata(GFGS_Google_Metadata $commonInstanceMetadata) {
  ...
  public function setQuotas(/* array(GFGS_Google_ProjectQuotas) */ $quotas) {
    $this->assertIsArray($quotas, 'GFGS_Google_ProjectQuotas', __METHOD__);
    $this->quotas = $quotas;
  }
...
class GFGS_Google_ProjectQuotas extends GFGS_Google_Model {
  public $usage;
  public $metric;
  public $limit;
...
class GFGS_Google_SerialPortOutput extends GFGS_Google_Model {
  public $kind;
  public $selfLink;
  public $contents;
  public function setKind($kind) {
...
class GFGS_Google_ServiceAccount extends GFGS_Google_Model {
  public $scopes;
  public $kind;
  public $email;
...
class GFGS_Google_Snapshot extends GFGS_Google_Model {
  public $status;
  public $kind;
  public $description;
  public $sourceDisk;
...
class GFGS_Google_SnapshotList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Snapshot';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(GFGS_Google_Snapshot) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Snapshot', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_Zone extends GFGS_Google_Model {
  public $status;
  public $kind;
  public $availableMachineType;
  public $description;
  protected $__maintenanceWindowsType = 'GFGS_Google_ZoneMaintenanceWindows';
  ...
  public function setMaintenanceWindows(/* array(GFGS_Google_ZoneMaintenanceWindows) */ $maintenanceWindows) {
    $this->assertIsArray($maintenanceWindows, 'GFGS_Google_ZoneMaintenanceWindows', __METHOD__);
...
class GFGS_Google_ZoneList extends GFGS_Google_Model {
  public $nextPageToken;
  protected $__itemsType = 'GFGS_Google_Zone';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $id;
  ...
  public function setItems(/* array(GFGS_Google_Zone) */ $items) {
    $this->assertIsArray($items, 'GFGS_Google_Zone', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class GFGS_Google_ZoneMaintenanceWindows extends GFGS_Google_Model {
  public $endTime;
  public $beginTime;
  public $name;
  public $description;
