        ...
        <section class="service-wrapper service-area">
            <div class="container">
                <div class="service-upperitem text-center">
                    <h1 class="title-xxl">Our Services</h1>
                    <ul>
                        <li><a href="#" class="button" data-scroll="#classic">CLASSIC</a></li>
                        <li><a href="#" class="button" data-scroll="#premium">PREMIUM</a></li>
                        <li><a href="#" class="button" data-scroll="#luxe-treatment">LUXE TREATMENTS</a></li>
                    </ul>
                </div>
                <div class="service-wrappart" id="classic">
                    <div class="carts-title mt-0">
                        <h4 class="title-xl2 ">CLASSIC</h4>
                    ...
                    <div class="service-wraprow">
                        ...
                        <div class="service-wrapbox">
                            ...
                            <span class="text-14 ">*This service may require a barber at some locations</span>
                        </div>
                        <div class="service-wrapbox">
                ...
                <div class="service-wrappart" id="premium">
                    <div class="carts-title mt-0">
                        <h4 class="title-xl2 ">PREMIUM</h4>
                        <img src="<?php echo get_theme_file_uri( 'assets/images/nail-min.png'); ?>" alt="">
                    </div>
                    <div class="service-wraprow">
                        <div class="service-wrapbox">
                            <h4 class="title-lg3">Premium Cut</h4>
                            <p class="text-16"><strong>Our ultimate cutting experience.</strong> TThis cut includes extra time for complex styles and finishing details. You’ll feel pampered with our straight razor outlines*, warm foam, and aftershave massage. Once you love the way you look and feel, we will finish with a shampoo, conditioning scalp massage, and a lavender-infused hot towel for your face. (approx. 45 minutes)</p>
                            <span class="text-14">*This service may require a barber at some locations</span>
                        </div>
                        <div class="service-wrapbox">
                ...
                <div class="service-wrappart" id="luxe-treatment">
                    <div class="carts-title mt-0">
